...
How GPT-5.6 Sol tracks risk and recovers from failure.
...
P = probability, M = medium, L = low, H = high. Adjust the prevention and
mitigation columns for each task.
...
- Switch to a documented fallback if the result is materially equivalent
